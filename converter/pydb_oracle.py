...
from sqlalchemy.dialects.oracle import \
    VARCHAR, NVARCHAR, CHAR, NCHAR, DATE, NUMBER, BLOB, BFILE, CLOB, NCLOB, \
    TIMESTAMP, RAW, FLOAT, DOUBLE_PRECISION, BINARY_DOUBLE, BINARY_FLOAT, \
    LONG, dialect, INTERVAL, VARCHAR2, NVARCHAR2, ROWID, REAL
...
def get_source_config():
    ...
    config = {}
    config['schema_list'] = input(
        '- Comma separated list of schema to migrate e.g. "s1,s2,s3" (default "None"): ') or None
