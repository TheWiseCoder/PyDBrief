...
COLUMN_TYPES: dict[str, Type] = {
    # SQL types
    "ref-array": REF_ARRAY,
    "ref-bigint": REF_BIGINT,
    "ref-binary": REF_BINARY,
    "ref-blob": REF_BLOB,
    "ref-boolean": REF_BOOLEAN,
    "ref-char": REF_CHAR,
    "ref-clob": REF_CLOB,
    "ref-date": REF_DATE,
    "ref-datetime": REF_DATETIME,
    "ref-decimal": REF_DECIMAL,
    "ref-double": REF_DOUBLE,
    "ref-double_precision": REF_DOUBLE_PRECISION,
    "ref-float": REF_FLOAT,
    "ref-int": REF_INT,
    "ref-integer": REF_INTEGER,
    "ref-json": REF_JSON,
    "ref-nchar": REF_NCHAR,
    "ref-numeric": REF_NUMERIC,
    "ref-nvarchar": REF_NVARCHAR,
    "ref-real": REF_REAL,
    "ref-smallint": REF_SMALLINT,
    "ref-text": REF_TEXT,
    "ref-time": REF_TIME,
    "ref-timestamp": REF_TIMESTAMP,
    "ref-uuid": REF_UUID,
    "ref-varbinary": REF_VARBINARY,
    "ref-varchar": REF_VARCHAR,

    # MySQL types
    "msql-bigint": MSQL_BIGINT,
    "msql-binary": REF_BINARY,
    "msql-bit": MSQL_BIT,
    "msql-blob": REF_BLOB,
    "msql-boolean": REF_BOOLEAN,
    "msql-char": MSQL_CHAR,
    "msql-date": REF_DATE,
    "msql-datetime": MSQL_DATETIME,
    "msql-decimal": MSQL_DECIMAL,
    "msql-double": MSQL_DOUBLE,
    "msql-enum": MSQL_ENUM,
    "msql-float": MSQL_FLOAT,
    "msql-integer": MSQL_INTEGER,
    "msql-json": MSQL_JSON,
    "msql-longblob": MSQL_LONGBLOB,
    "msql-longtext": MSQL_LONGTEXT,
    "msql-mediumblob": MSQL_MEDIUMBLOB,
    "msql-mediumint": MSQL_MEDIUMINT,
    "msql-mediumtext": MSQL_MEDIUMTEXT,
    "msql-nchar": MSQL_NCHAR,
    "msql-numeric": MSQL_NUMERIC,
    "msql-nvarchar": MSQL_NVARCHAR,
    "msql-real": MSQL_REAL,
    "msql-set": MSQL_SET,
    "msql-smallint": MSQL_SMALLINT,
    "msql-text": MSQL_TEXT,
    "msql-time": MSQL_TIME,
    "msql-timestamp": MSQL_TIMESTAMP,
    "msql-tinyblob": MSQL_TINYBLOB,
    "msql-tinyint": MSQL_TINYINT,
    "msql-tinytext": MSQL_TINYTEXT,
    "msql-varbinary": REF_VARBINARY,
    "msql-varchar": MSQL_VARCHAR,
    "msql-year": MSQL_YEAR,

    # Oracle types
    "orcl-bfile": ORCL_BFILE,
    "orcl-binary_double": ORCL_BINARY_DOUBLE,
    "orcl-binary_float": ORCL_BINARY_FLOAT,
    "orcl-blob": REF_BLOB,
    "orcl-char": REF_CHAR,
    "orcl-clob": REF_CLOB,
    "orcl-date": ORCL_DATE,
    "orcl-double_precision": REF_DOUBLE_PRECISION,
    "orcl-float": ORCL_FLOAT,
    "orcl-interval": ORCL_INTERVAL,
    "orcl-long": ORCL_LONG,
    "orcl-nchar": REF_NCHAR,
    "orcl-nclob": ORCL_NCLOB,
    "orcl-number": ORCL_NUMBER,
    "orcl-nvarchar": REF_NVARCHAR,
    "orcl-nvarchar2": REF_NVARCHAR,
    "orcl-raw": ORCL_RAW,
    "orcl-real": REF_REAL,
    "orcl-rowid": ORCL_ROWID,
    "orcl-timestamp": ORCL_TIMESTAMP,
    "orcl-varchar": REF_VARCHAR,
    "orcl-varchar2": ORCL_VARCHAR2,

    # Postgres types
    "pg-array": PG_ARRAY,
    "pg-bigint": REF_BIGINT,
    "pg-bit": PG_BIT,
    "pg-boolean": REF_BOOLEAN,
    "pg-bytea": PG_BYTEA,
    "pg-char": REF_CHAR,
    "pg-cidr": PG_CIDR,
    "pg-citext": PG_CITEXT,
    "pg-date": REF_DATE,
    "pg-datemultirange": REF_DATEMULTIRANGE,
    "pg-daterange": REF_DATERANGE,
    "pg-domain": PG_DOMAIN,
    "pg-double_precision": REF_DOUBLE_PRECISION,
    "pg-enum": PG_ENUM,
    "pg-float": REF_FLOAT,
    "pg-hstore": PG_HSTORE,
    "pg-inet": PG_INET,
    "pg-int4multirange": PG_INT4MULTIRANGE,
    "pg-int4range": PG_INT4RANGE,
    "pg-int8multirange": PG_INT8MULTIRANGE,
    "pg-int8range": PG_INT8RANGE,
    "pg-integer": REF_INTEGER,
    "pg-interval": PG_INTERVAL,
    "pg-json": PG_JSON,
    "pg-jsonb": PG_JSONB,
    "pg-jsonpath": PG_JSONPATH,
    "pg-macaddr": PG_MACADDR,
    "pg-macaddr8": PG_MACADDR8,
    "pg-money": PG_MONEY,
    "pg-numeric": REF_NUMERIC,
    "pg-nummultirange": PG_NUMMULTIRANGE,
    "pg-numrange": PG_NUMRANGE,
    "pg-oid": PG_OID,
    "pg-real": REF_REAL,
    "pg-regclass": PG_REGCLASS,
    "pg-regconfig": PG_REGCONFIG,
    "pg-smallint": REF_SMALLINT,
    "pg-text": REF_TEXT,
    "pg-time": PG_TIME,
    "pg-timestamp": PG_TIMESTAMP,
    "pg-tsmultirange": PG_TSMULTIRANGE,
    "pg-tsquery": PG_TSQUERY,
    "pg-tsrange": PG_TSRANGE,
    "pg-tstzmultirange": PG_TSTZMULTIRANGE,
    "pg-tstzrange": PG_TSTZRANGE,
    "pg-tsvector": PG_TSVECTOR,
    "pg-uuid": REF_UUID,
    "pg-varchar": REF_VARCHAR,

    # SQLServer types
    "sqls-bigint": REF_BIGINT,
    "sqls-binary": REF_BINARY,
    "sqls-bit": SQLS_BIT,
    "sqls-char": REF_CHAR,
    "sqls-date": REF_DATE,
    "sqls-datetime": REF_DATETIME,
    "sqls-datetime2": SQLS_DATETIME2,
    "sqls-datetimeoffset": REF_DATETIMEOFFSET,
    "sqls-decimal": REF_DECIMAL,
    "sqls-double_precision": SQLS_DOUBLE_PRECISION,
    "sqls-float": REF_FLOAT,
    "sqls-image": SQLS_IMAGE,
    "sqls-integer": REF_INTEGER,
    "sqls-json": SQLS_JSON,
    "sqls-money": SQLS_MONEY,
    "sqls-nchar": REF_NCHAR,
    "sqls-ntext": SQLS_NTEXT,
    "sqls-numeric": REF_NUMERIC,
    "sqls-nvarchar": REF_NVARCHAR,
    "sqls-real": SQLS_REAL,
    "sqls-rowversion": SQLS_ROWVERSION,
    "sqls-smalldatetime": SQLS_SMALLDATETIME,
    "sqls-smallint": REF_SMALLINT,
    "sqls-smallmoney": SQLS_SMALLMONEY,
    "sqls-sql_variant": SQLS_SQL_VARIANT,
    "sqls-text": REF_TEXT,
    "sqls-time": SQLS_TIME,
    "sqls-timestamp": SQLS_TIMESTAMP,
    "sqls-tinyint": SQLS_TINYINT,
    "sqls-uniqueidentifier": SQLS_UNIQUEIDENTIFIER,
    "sqls-varbinary": SQLS_VARBINARY,
    "sqls-varchar": REF_VARCHAR,
    "sqls-xml": SQLS_XML,
}
