...
class MigrationTableWork(PySob):
    """
    ...
    def __init__(self,
        ...
        if __id:
            where_data = {MigrationTableWork.Db.ID: __id}
        elif id_migration and nm_table:
            where_data = {MigrationTableWork.Db.ID_MIGRATION: id_migration,
                          MigrationTableWork.Db.NM_TABLE: nm_table}
...
MigrationTableWork.initialize(db_specs=(MigrationTableWork.Db, int),
                              attrs_unique=MigrationTableWork.ATTRS_UNIQUE,
                              logger=MigrationTableWork.LOGGER)
